...
"""
Training script
- positional embedding is added in the attention head instead
- training on lesser epochs than GPTv2
"""
...
model = GPTv3(vocab_size, n_embed)
...
torch.save(model.state_dict(), "model/v3")
